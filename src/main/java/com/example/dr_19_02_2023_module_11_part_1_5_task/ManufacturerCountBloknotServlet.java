...
@WebServlet(name = "ManufacturerCountBloknotServlet", value = "/ManufacturerCountBloknotServlet")
public class ManufacturerCountBloknotServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<h1>Виробники</h1>");
            String selectAll="SELECT namemanufacturer,Count(Namebloknot)\n" +
                    "FROM public.bloknot\n" +
                    "group by namemanufacturer;";
            ResultSet resultSet=statement.executeQuery(selectAll);
            out.println("<table border='1'>");//
            out.println("<tr><th>№ </th><th>Назва виробника</th><th>Кількість блокнотів</th></tr>");
            int resId = 1;
