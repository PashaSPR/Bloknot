...
@WebServlet(name = "MaxManufacturerCountBloknotServlet", value = "/MaxManufacturerCountBloknotServlet")
public class MaxManufacturerCountBloknotServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<h1>Виробник з максимальною кількістю блокнотів</h1>");
